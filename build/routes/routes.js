...
class Routes {
    constructor() {
        ...
        this.postConductor = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { DNI, nombre, apellidos, fechaNac, salHora, cargo, licencias, incidencias } = req.body;
        ...
        this.postMecanico = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { DNI, nombre, apellidos, fechaNac, salHora, cargo, especialidad, ubicacion } = req.body;
            yield database_1.db.conectarBD();
            dSchemaMecanico = {
                DNI: DNI,
                nombre: nombre,
        ...
        this.postTren = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { matricula, numPlazas, fechaInicio, pagoTarjeta, trabajadores, tipoTren, estaciones } = req.body;
            yield database_1.db.conectarBD();
            const dSchemaTren = {
                matricula: matricula,
                numPlazas: numPlazas,
        ...
        this.postAutobus = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { matricula, numPlazas, fechaInicio, pagoTarjeta, trabajadores, baño, numPlantas } = req.body;
            yield database_1.db.conectarBD();
        ...
        this.getVehiculos = (req, res) => __awaiter(this, void 0, void 0, function* () {
            yield database_1.db.conectarBD()
                .then(() => __awaiter(this, void 0, void 0, function* () {
                const j = yield vehiculos_1.Vehiculos.findOne({});
                res.json(j);
            }))
                .catch((mensaje) => {
                res.send(mensaje);
